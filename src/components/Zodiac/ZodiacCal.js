...
const ZodiacCal = () => {
  ...
  return (
    ...
    <div className="card3">  
            ...
            <a id="animated" onClick={zodiac}><button class= "button1">Find your zodiac sign! </button> </a>
            
            <h2 id= "space">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Your zodiac sign is <span id="output"></span> </h2>
